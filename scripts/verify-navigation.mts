...
const cases: Array<[string, string, string | undefined]> = [
  ...
  ['/admin/users/employees', 'admin-users-employees', 'admin-users'],
  ['/admin/users/employees/new', 'admin-users-employees', 'admin-users'],
  ['/admin/users/support-staff', 'admin-users-support', 'admin-users'],
  ['/admin/users/accountants', 'admin-users-accountants', 'admin-users'],
  ['/admin/users/branch-admin', 'admin-users-branch-admin', 'admin-users'],
  ['/quotation', 'admin-quotation', undefined],
  ['/quotation/new', 'admin-quotation', undefined],
